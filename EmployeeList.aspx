<%@ Page Title="EmployeeList" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EmployeeList.aspx.cs" Inherits="LAB06___Travis_Thaxter.EmployeeList" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <h2><%: Title %>.</h2>
    <asp:GridView ID="gvEmployeeList" runat="server" UseAccessibleHeader="true" AutoGenerateSelectButton="True" OnSelectedIndexChanged="gvEmployeeList_SelectedIndexChanged" ></asp:GridView>
    <p>
        Worker First Name: <asp:TextBox ID="txtFirstName" runat="server" ToolTip="Enter the worker's first name." Enabled="False" /> 
    ...
    <p>
        Worker Last Name: <asp:TextBox ID="txtLastName" runat="server" ToolTip="Enter the worker's last name." Enabled="False" /> 
    ...
    <p>
        Messages Sent: <asp:TextBox ID="txtMessagesSent" runat="server" ToolTip="Enter the messages sent by the worker." Enabled="False" /> 
    ...
    <p>
        <asp:RadioButtonList ID="rblWorkerType" runat="server" ToolTip="Select your worker classification" Enabled="False">
            <asp:ListItem Selected="True" Value="Piecework" >Regular Worker (Plebeians)</asp:ListItem>
